  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        add_temples: resolve(__dirname, "src/addTemples/index.html"),
        ...
        add_properties: resolve(__dirname, "src/rooms/addProperties.html"),
        inventory: resolve(__dirname, "src/inventory/index.html"),
        add_inventory: resolve(__dirname, "src/rooms/addInventory.html"),
